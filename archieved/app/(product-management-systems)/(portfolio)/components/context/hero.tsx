  ...
  return (
    <main className="flex lg:flex-row flex-col lg:h-screen h-auto items-center justify-center mb-5 mt-5 gap-2">
      ...
      <section className="lg:w-1/2 w-full lg:mr-[20%]">
        ...
        <div className="flex lg:flex-row flex-col lg:gap-0 gap-2 mt-2 lg:border-[1px] border-[#faad86]/20 lg:border-none p-2 rounded-md w-full md:w-full lg:w-1/2 items-center justify-between">
