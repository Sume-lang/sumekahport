  ...
  return (
    <SliderInOut>
      <section className="p-8 h-auto flex lg:flex-row flex-col">
        <nav className="lg:flex flex-col grid grid-cols-2 gap-2 lg:w-1/3 w-full border-[1px] border-slate-50/10 p-2 rounded-md">
          {tips.map((tip, index) => (
            <button
              key={index}
        ...
        <section className="w-full">
          <div className="lg:text-[15px] text-md font-light shadow-md w-full">
